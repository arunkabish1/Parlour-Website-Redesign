    ...
    <div className="">
      <div className="">
        ...
        <video
          controls
          type="video/mp4"
          className={` pt-10 px-10 pb-3 rounded-llg ${
            video2 ? "" : "hidden transition-opacity"
          }`}
        ...
        {/* <video
          controls
          type="video/mp4"
          className={` p-10 rounded-llg ${video3 ? "" : "hidden"}`}
          src="https://ufmlxewvhsitvlrggfwn.supabase.co/storage/v1/object/public/rainbow/Snapinsta.app_video_AQNT4AjghESyIF25u0AfIj-Q1D9sMGCZNtEdHP5X_bOyiJfap9RYPJBviAd-xWLpdlGJX6ewgztSbPJ8uE60tqP6CPV8bE6Au9rXdD8.mp4"
        ></video> */}
        <div className="flex justify-center items-center gap-10">
          <button onClick={togglePrev} className="">
            <svg
              fill="#ffffff"
              height="32px"
              width="32px"
          ...
          <button onClick={toggleNext} className="">
            <svg
              fill="#ffffff"
              height="32px"
              width="32px"
